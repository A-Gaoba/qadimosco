...
export default function HotelsClientPage() {
  ...
  const hotelsData: Hotel[] = [
    ...
    },
    {
      ...
      nameAr: "فندق كارلتون موسكو",
      stars: 5,
      distance_from_center_km: 0.1,
      description: "Luxury hotel formerly known as The Ritz-Carlton, offering panoramic city views.",
      descriptionAr: "فندق فاخر كان يُعرف سابقًا باسم ريتز كارلتون، يوفر إطلالات بانورامية على المدينة",
      city: "Moscow",
      cityAr: "موسكو",
      type: "hotel",
      image: "/placeholder.svg?height=300&width=400",
      amenities: ["Panoramic Views", "Luxury Rooms", "Central Location", "Fine Dining"],
      amenitiesAr: ["إطلالات بانورامية", "غرف فاخرة", "موقع مركزي", "مطاعم راقية"],
    },
    {
      id: "moscow-8",
